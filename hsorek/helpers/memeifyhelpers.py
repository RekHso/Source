...
from wand.image import Image as hsorekimage

from .utils import _hsorekutils
...
async def hsorek_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def hsorek_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = hsorekimage(filename=picture_name)
    main_image.resize(
