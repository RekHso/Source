...
PATH = "./hsorek/cache/ytsearch.json"
...
async def yt_search(hsorek):
    try:
        hsorek = urllib.parse.quote(hsorek)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={hsorek}"
        )
...
"""
async def yt_data(hsorek):
    params = {"format": "json", "url": hsorek}
