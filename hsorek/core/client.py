...
class sourceUserBotClient(TelegramClient):
    def ar_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[هنا](https://t.me/source_support)"
            ...
            if pattern is not None:
                ...
                if edited:
                    hsorek.add_event_handler(func, events.MessageEdited(**kwargs))
                hsorek.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                hsorek.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                hsorek.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
sourceUserBotClient.fast_download_file = download_file
sourceUserBotClient.fast_upload_file = upload_file
sourceUserBotClient.reload = restart_script
sourceUserBotClient.get_msg_link = get_message_link
sourceUserBotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    sourceUserBotClient.send_message = send_message
    sourceUserBotClient.send_file = send_file
    sourceUserBotClient.edit_message = edit_message
