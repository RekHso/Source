...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        ...
        "UPSTREAM_REPO", "https://github.com/rekhso/Source"
    ...
    source_START = os.environ.get("source_START", None)

    PMPERMIT_TEXT_source = os.environ.get("PMPERMIT_TEXT_source", None)
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "source")
    ...
    # specify NO_LOAD with plugin names for not loading in source
    ...
    # Google Drive plugin https://telegra.ph/G-Drive-guide-for-catsource-01-01
